...
- `price` < Price >: The price of Bitcoin applying to the trade, the price is defined in < Currency >, if `0` means that the price will be obtained from a public API after the taker accepts the order.
